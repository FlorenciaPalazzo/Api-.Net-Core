...
namespace WebApiPubs.Models
{
    public partial class PubsContext : DbContext
    {
        ...
        //Revisar los nombres de los modelos que sean en singular y los de conexiones en plural (<Author>Authors)
        ...
        {
            //Comentarlo porque asi lo trae Microsoft configurado y no es buena practica
